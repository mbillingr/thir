...
The current branch adds a REPL to make interaction with the system easier. An interpreter is also planned, and all the
plumbing to create a working language.